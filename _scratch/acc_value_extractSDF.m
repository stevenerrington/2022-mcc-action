function signal_average = acc_value_extractSDF(dirs,dataFiles_beh,dataFiles_neural,behavior)
...
parfor dataFileIdx = 1:length(dataFiles_neural)
    ...
    trials.reward.hi = behavior(behaviorIdx).
    
    signal_average{dataFileIdx} = neural_ttxSignalAverage(spk_data,...
