function [ch_val, unch_val, ch_nStates, unch_nStates, ch_times, unch_times] = get_trialState_details_v02(t_values, choice_dirs, animal_id,...
                                                                                ch_states, unch_states, t_mids)
...
[~,state_win_start_time_ix] = min(abs(t_mids - 50));
